...
namespace Kbg.NppPluginNET
{
    class Main
    {
        internal const string PluginName = "NppPlugin.Host";
        static string iniFilePath = null;
        static bool someSetting = false;
        static frmMyDlg frmMyDlg = null;
        static int idMyDlg = -1;
        static Bitmap tbBmp = NppPlugin.Host.Properties.Resources.star;
        static Bitmap tbBmp_tbTab = NppPlugin.Host.Properties.Resources.star;
