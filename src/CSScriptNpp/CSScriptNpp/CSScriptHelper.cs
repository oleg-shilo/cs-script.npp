        ...
        public class Integration
        {
            ...
            public static void ShowIntegrationInfo()
            {
                var content = new StringBuilder()
                        ...
                        .AppendLine()
                        .AppendLine("If you cannot update because script engine or syntaxer executables are locked, you can always terminate any running instance with:")
                        .AppendLine("  `css -kill`")
                        .AppendLine("  `syntaxer -kill`")
                        .AppendLine()
                        .AppendLine("---------------")
                        .AppendLine()
