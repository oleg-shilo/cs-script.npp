...
namespace Microsoft.Samples.Debugging.MdbgEngine
{
    ...
    public static class Extensions //zos; CSScript.Npp related changes
    {
        public static bool IsSet(this CorDebugUserState value, CorDebugUserState bitValue)
        {
            return (value | bitValue) == value;
        }

        public static bool IsEvalSafe(this MDbgProcess proc)
        {
    ...
    public sealed class MDbgProcess : MarshalByRefObject
    {
        ...
        public MDbgFunction ResolveFunctionNameFromScope(string functionName, CorAppDomain appDomain)
        {
            ...
            // The last argument to the ResolveFunctionName is appDomain we are referring to.
        ...
        /// <summary>
        /// Resolves a Function name in a given scope.
        /// </summary>
            ...
            if (var != null)
            {
                ...
                for (int i = nextPart; i < nameParts.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        var field = var.GetFields().Where(f => f.Name == part).FirstOrDefault();
                        if (field != null)
                        {
                            var = field;
                            continue;
                        ...
                        var prop = var.GetProperties(part).FirstOrDefault();
                        if (prop != null)
                        {
                            var = prop;
                            continue;
        ...
        private void StepImpl(bool stepNativeCode, StepperType type)
        {
            ...
            //zos; CSScript.Npp related changes; 
            //otherwise it stuffs up the whole execution: 'pseudo-deadlock'
            if (stepper != null)
